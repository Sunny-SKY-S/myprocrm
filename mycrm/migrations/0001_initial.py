# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-10-09 09:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mycrm.Branch', verbose_name='校区')),
            ],
        ),
        migrations.CreateModel(
            name='Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mycrm.ClassList')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('consult_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mycrm.Course', verbose_name='咨询课程')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intention', models.SmallIntegerField(choices=[(0, '2周内报名'), (1, '1个月内报名'), (2, '近期无报名计划'), (3, '已报名'), (4, '已拉黑')])),
                ('date', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mycrm.Enrollment')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.ManyToManyField(blank=True, null=True, to='mycrm.Role')),
        ...
        migrations.AddField(
            model_name='payment',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mycrm.Course', verbose_name='所报课程'),
        ),
        migrations.AddField(
            model_name='payment',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mycrm.Customer'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='enrollment',
            name='enrolled_class',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mycrm.ClassList', verbose_name='所报班级'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='customer',
            name='tags',
            field=models.ManyToManyField(blank=True, null=True, to='mycrm.Tag'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='classlist',
            name='teachers',
            field=models.ManyToManyField(to='mycrm.UserProfile'),
        ),
